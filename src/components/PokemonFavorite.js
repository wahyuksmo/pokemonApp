                      ...
                      <div className="card-body">
                        ...
                        <ul className="list-group list-group-flush">
                          ...
                          >
                            ...
                            <button className="btn btn-primary mt-4" onClick={addtoFavorite}>Primary</button>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="row g-0">
                      ...
                      <div className="col-md-8">
                        <div className="card-body">
                          ...
                          <button className="btn btn-primary mt-4" onClick={addtoFavorite.bind(this, pokemon.id)}>Primary</button>
                        </div>
                      </div>
                    </div>
                  </div>
